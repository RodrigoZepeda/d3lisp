Contribute to d3lisp
================

# Contributing

When contributing to this repository, please first discuss major changes
to the existing code you wish to make via issue. Minor changes and major
additions are welcome as long as they are released under the MIT License
(add to your file).
